...
katherine = Chef.create!(name: "Katherine", bio: 'Sample Bio for Chef Goes Here',  years_experience:20, hourly_rate: 45, location: "Los Angeles", cuisines: "French, Italian, Mexican")
